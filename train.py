...
from torch.autograd import Variable # Useful info about autograd: http://pytorch.org/docs/`mas`ter/notes/autograd.html
...
if __name__ == "__main__":
    ...
    # Thang's dataset
    bg_file_names = get_all_files('doube-augmented')
